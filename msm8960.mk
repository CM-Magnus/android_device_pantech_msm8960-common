...
# GPS config
PRODUCT_COPY_FILES += \
    device/pantech/msm8960-common/configs/gps.conf:system/etc/gps.conf

# Hostapd config
PRODUCT_COPY_FILES += \
    device/pantech/msm8960-common/configs/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf
...
$(call inherit-product-if-exists, vendor/pantech/msm8960-common/msm8960-common-vendor.mk)
